    ...
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-usage_qwen="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'qwen')" />
          </template>

          <template #cell-usage_mimo="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'mimo')" />
          </template>

          <template #cell-usage_ark="{ row }">
            <PlatformCostCell :usage="getPlatformUsage(row.id, 'ark')" />
          </template>
...
const allColumns = computed<Column[]>(() => [
  ...
  { key: 'usage_qwen', label: t('admin.users.columns.usageQwen'), sortable: false },
  { key: 'usage_mimo', label: t('admin.users.columns.usageMimo'), sortable: false },
  { key: 'usage_ark', label: t('admin.users.columns.usageArk'), sortable: false },
...
const DEFAULT_HIDDEN_COLUMNS = [
  ...
  'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_qwen', 'usage_mimo', 'usage_ark',
...
const USAGE_COLUMN_KEYS: readonly string[] = ['usage', 'usage_anthropic', 'usage_openai', 'usage_gemini', 'usage_antigravity', 'usage_qwen', 'usage_mimo', 'usage_ark']
