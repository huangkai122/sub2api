...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'mimo': return 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-400'
    case 'ark': return 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'mimo': return 'text-rose-700 dark:text-rose-400'
    case 'ark': return 'text-cyan-700 dark:text-cyan-400'
    default: return ''
  }
}
