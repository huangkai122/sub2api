...
const PROVIDER_ICONS: Record<Provider, IconData> = {
  ...
  // 以下三个图标与 src/components/common/PlatformIcon.vue 中同名平台保持一致。
  qwen: {
    paths: [
  ...
  mimo: {
    paths: [
      'M4 18V6h2.5l5.5 8 5.5-8H20v12h-2.5v-7.5L12 17l-5.5-6.5V18H4z',
    ],
  },
  ark: {
    paths: [
      'M12 2L4 20h4l4-10 4 10h4L12 2zm0 5l2.5 6h-5L12 7z',
    ],
  },
}
